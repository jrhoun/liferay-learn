...
ワークスペースにユーザーを追加する方法の詳細については、 [ユーザーの管理](../../administration/managing-users.md) を参照してください。
...
ワークスペース設定の詳細については、 [アナリティクス プロジェクトの管理](../../administration/managing-projects.md)を参照してください。
