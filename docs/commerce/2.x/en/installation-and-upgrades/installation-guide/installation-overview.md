...
Subscribers who have purchased Liferay Commerce Enterprise are required to both download the _enterprise_ version of the `LPKG` from [Help Center](https://customer.liferay.com/downloads) and then activate the product. See [Activating Liferay Commerce Enterprise](./activating-liferay-commerce-enterprise.md).
