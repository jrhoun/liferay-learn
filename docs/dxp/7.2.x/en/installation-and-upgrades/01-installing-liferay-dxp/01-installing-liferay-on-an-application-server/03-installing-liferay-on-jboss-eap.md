...
Installing DXP on JBoss EAP 7.1 takes three basic steps:
...
The easiest way to handle the database configuration is to let DXP manage the data source. The [Basic
Configuration](../04-connecting-a-database.md) page lets administrators configure DXP's built-in data source. If using the built-in data source, skip this section.
