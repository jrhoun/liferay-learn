...
```note::
   The ``singleton_name`` TCP attribute was deprecated in JGroups v4.0.0 and has therefore been removed since Liferay DXP 7.2 SP1 and Liferay Portal CE GA3 which use JGroups v 4.1.1-Final.
```
