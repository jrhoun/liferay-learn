...
1. Open the Product Menu and, under the Site Menu, go to _Site Builder_ &rarr; _Pages_ to open the Site Builder.
1. Click the Add Page button (![Add Page](../../../images/icon-plus.png)) at the level where you want to add the new page, and select _Add Page_.

    ![Begin by adding your new Content Page.](building-content-pages/images/01.png)

1. Select the _Blank_ template or one of the exiting templates.
