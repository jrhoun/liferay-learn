...
In the _Name_ field, you can set a page's title, which is used for Site navigation and the browser's title bar. You can also use the _Friendly URL_ field to set a new URL for a page or click the _Restore_ icon ( ![Friendly URL Restore icon](./../../../images/icon-restore.png) ) to see and restore a previously used URL. <!--Link to Friendly URL article when finished.-->
...
Here you can set a custom URL that is used instead of the URL set in your _System_ or _Instance_ settings.
