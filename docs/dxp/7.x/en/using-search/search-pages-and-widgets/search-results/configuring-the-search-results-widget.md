...
**Pagination Delta:** Set the number of results to display per results page. Defaults to _20_ unless you customized the `search.container.page.default.delta` [property](https://docs.liferay.com/ce/portal/7.3-latest/propertiesdoc/portal.properties.html#Search%20Container) in your `portal-ext.properties` file.
